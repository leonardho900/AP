...
public class MyTest extends Application {
    ...
    //private MyResult winResult; to show all questions and the answer, wrong/correct, percentage
    private LinkedList<Question> quesList = new LinkedList<Question>();

    public void start(Stage mainStage) {
        mainStage.setTitle("MAMAT Battle Royale");
        Label labNameDesc = new Label("Contestant Name");
        labNameDesc.setLayoutX(25);
        labNameDesc.setLayoutY(25);
        labName = new Label("");
        labName.setLayoutX(150);
        labName.setLayoutY(25);
        labName.setStyle("-fx-font-weight:bold;;-fx-border-color:black;");
